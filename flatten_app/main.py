...
if __name__ == "__main__":
    ...
    try:
        ...
        with open(r"C:\\vscode\\BJB-FilePathFlatter\\debug_main_entry.txt", "w", encoding="utf-8") as f:
        ...
        with open(r"C:\\vscode\\BJB-FilePathFlatter\\debug_main_entry.txt", "a", encoding="utf-8") as f:
            f.write(f"[ERROR] {e}\n")
    if '--cli' in sys.argv:
        print("CLIモード（未実装）")
    else:
